...
(
   ...
   "expire" timestamp
	...
	CREATE TABLE "public"."clans_invitations"
	(
		"id" serial,
		"clan_id" integer,
		"inviter_id" integer,
		"invitee_id" integer,
		PRIMARY KEY ("id"),
		CONSTRAINT "clan_id" FOREIGN KEY ("clan_id") REFERENCES "public"."clan"("clan_id"),
		CONSTRAINT "inviter_id" FOREIGN KEY ("inviter_id") REFERENCES "public"."users"("user_id"),
		CONSTRAINT "invitee_id" FOREIGN KEY ("invitee_id") REFERENCES "public"."users"("user_id")
	);
